...
import com.avinash.restapi.repository.EmployeeRepository;
...
public class EmployeeController {
	...
	ResponseEntity<Employee> updateEmployeeById(@PathVariable Long id, @RequestBody Employee employeeDetails){
		Employee employee = employeeRepository.findById(id)
				.orElseThrow(()-> new ResourceNotFoundException("Employee Not exist with id: " + id));
